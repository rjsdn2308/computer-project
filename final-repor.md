...
2. 데이터셋 로딩 및 전처리  
3. 데이터 증강  
4. EfficientNetV2S 기반 전이학습 모델 구성  
5. 모델 학습 및 EarlyStopping, Checkpoint 적용  
6. TFLite 변환으로 모바일 배포 가능
...
**기능 및 특징:**  
* 제스처 + 사용자 명령어 입력 → LLM 피드백 생성  
* HTML 기반 시각화  
* 한국어/영어 지원, 스마트홈 IoT 확장 가능
